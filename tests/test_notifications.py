...
# Backfill script lives at the project root; load it as a module so the
# network-free helpers (_parse_json_array, _classify_model) can be unit-tested.
